...
class WorkspaceView implements IBaseComponent {
                    ...
                    $("<div>").appendTo(container).dxToolbar({
                        items: [{
                            ...
                            options: {
                                ...
                                onClick: () => {
                                    OGUtils.confirm("Bạn muốn xóa workspace này?").then(value => {
                                        if (value) {
                            ...
                            options: {
                                ...
                                items: [{
                                    hint: "Xem bản đồ workspace",
                                    onClick: () => {
                                        window.open("/cms/map?id=" + options.data.id, "_blank");
                                    },
                                    text: "Xem bản đồ workspace",
                                    type: "default"
                                }, {
                                    hint: "Lưu cấu hình trình bày workspace thành tệp",
                                    onClick: () => {
                                        OGUtils.postDownload("/api/map/export/templates", { id: options.data.id });
                                    },
                                    text: "Lưu cấu hình trình bày workspace thành tệp",
                                    type: "default"
                                }, {
                                    onClick: () => {
                                        this.mapInfo = options.data;
            ...
            onToolbarPreparing: (e) => {
                e.toolbarOptions.items.unshift({
                    ...
                    options: {
                        ...
                        text: "Tạo workspace từ mẫu có sẵn",
                        type: "success"
                    },
                    widget: "dxButton"
                }, {
    ...
    private initTemplatesMap(): void {
        this.createMapFromTemplatesPopup = $("<div />").appendTo("body").dxPopup({
                ...
                this.createMapFromTemplatesForm = $("<div />").appendTo(container)
                    .dxForm({
                        ...
                        items: [{
                            ...
                            validationRules: [{
                                message: "Vui lòng chọn mẫu từ workspace mẫu có sẵn",
                                type: "required"
                            }]
                        }, {
                            template: () => {
            ...
            showTitle: true,
            title: "Tạo workspace chuyên đề từ mẫu có sẵn",
            width: 400,
        }).dxPopup("instance");
    }
