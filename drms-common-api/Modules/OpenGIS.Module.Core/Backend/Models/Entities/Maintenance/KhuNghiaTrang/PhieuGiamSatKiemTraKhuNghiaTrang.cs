...
namespace OpenGIS.Module.Core.Models.Entities.Maintenance.KhuNghiaTrang
{
    [Table("nghiatrang_phieugiamsatgiaovieckiemtra", Schema = "maintenance")]
    public class PhieuGiamSatKiemTraKhuNghiaTrang
    {
        public PhieuGiamSatKiemTraKhuNghiaTrang()
        {
        }
