...
namespace OpenGIS.Module.Core.Models.Entities.Maintenance.KhuCongNghiep
{
    [Table("kcn_phieugiamsatgiaovieckiemtra", Schema = "maintenance")]
    public class PhieuGiamSatKiemTraKhuCongNghiep
    {
        public PhieuGiamSatKiemTraKhuCongNghiep()
        {
        }
