...
namespace OpenGIS.Module.Core.Models.Entities.Maintenance.ChieuSang
{
    [Table("cs_phieugiamsatgiaovieckiemtra", Schema = "maintenance")]
    public class PhieuGiamSatKiemTraChieuSang
    {
        public PhieuGiamSatKiemTraChieuSang()
        {
        }
