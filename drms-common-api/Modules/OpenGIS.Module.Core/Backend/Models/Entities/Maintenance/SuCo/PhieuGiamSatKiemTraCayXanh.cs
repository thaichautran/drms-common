...
namespace OpenGIS.Module.Core.Models.Entities.Maintenance.SuCo
{
    [Table("suco_phieugiamsatgiaovieckiemtra", Schema = "maintenance")]
    public class PhieuGiamSatKiemTraSuCo
    {
        public PhieuGiamSatKiemTraSuCo()
        {
        }
